...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"><h1>{{ __('site.publishers') }}</h1></div>

                <div class="card-body">                  
                    <div class="row justify-content-center my-1">
                        <form method="GET" action="{{ route('gallery.publishers.search') }}">
                    ...
                    <ol start="1" class="w3-ul">
                        @foreach ($publishers as $pub)
                            <li class="card-subtitle"><a href="{{ route('gallery.publishers.show',$pub->id) }}">{{ $pub->name }}</a> - ({{ count($pub->books) }})</li>
                        @endforeach
                    </ol>
                </div>
            </div>
